...
class PastaPage extends StatefulWidget {
  ...
  @override
  PastaPageState createState() => PastaPageState();
}

class PastaPageState extends State<PastaPage> {
  late Future<List<ItemModel>> pastas;
  ...
  Widget build(BuildContext context) {
    void viewItem(ItemModel pasta) {
      final page = ItemPage(currentItem: pasta);
      ...
      body: FutureBuilder<List<ItemModel>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No pastas found'));
          }

          final pastaList = snapshot.data!;
          ...
          return SingleChildScrollView(
            ...
            child: Center(
              child: Column(
                ...
                children: List.generate(pastaList.length, (pastaIndex) {
                  final pasta = pastaList[pastaIndex];
                  return InkWell(
                    onTap: () => viewItem(pasta),
                              ...
                              ClipRRect(
                                ...
                                child: Hero(
                                  ...
                                  child: Image(
                                    width: 120,
                                    height: 120,
                                    image: AssetImage(pasta.photoPath),
                                    fit: BoxFit.cover,
                                  ),
                                ),
                              ),
